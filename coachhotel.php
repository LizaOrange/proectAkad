...
<head>
    ...
    <title>Преподаватель, тренинг менеджер в гостиничной сфере</title>
    ...
    <section class="home home--admin">
        <div class="container">
            <div class="home__content">
                <div class="img-admin">
                    <img src="images/theHeadMobile.webp" loading="lazy" alt="Преподаватель, тренинг менеджер в гостиничной сфере">
                </div>
                <h1 class="home__title">«Преподаватель, тренинг менеджер в гостиничной сфере»</h1>
    ...
    <section class="features">
        <div class="container">
            ...
            <ul class="features__items">
                <li class="features__item">Использовать в работе передовые методики обучения и наставничества</li>
                <li class="features__item">Разрабатывать обучающие программы и материалы</li>
                <li class="features__item">Организовывать кейс-стади и практические мероприятия</li>
                <li class="features__item">Анализировать и давать оценку процессам управления отелем</li>
            </ul>
        </div>
    </section>
...
<!--                            <button class="form-tooltip__btn" type="button"><img src="images/info-form.svg" alt=""></button>-->
                        ...
                        <input type="hidden" class="program-hidden program-class-text" name="Program" value="Преподаватель, тренинг менеджер в гостиничной сфере">
