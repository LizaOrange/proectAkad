...
<head>
    ...
    <title>Менеджер по управлению персоналом в гостиничной сфере</title>
...
<main>
    <section class="container breadcrumbs">
        <p><a href="catalog.php">Каталог программ</a>/ Менеджер по управлению персоналом в гостиничной сфере</p>
    </section>
    ...
    <section class="home home--admin">
        <div class="container">
            <div class="home__content">
                <div class="img-admin">
                    <img src="images/theHeadMobile.webp" loading="lazy" alt="Менеджер по управлению персоналом в гостиничной сфере">
                </div>
                <h1 class="home__title">«Менеджер по управлению персоналом в гостиничной сфере»</h1>
    ...
    <section class="features">
        <div class="container">
            ...
            <ul class="features__items">
                <li class="features__item">Управлять сотрудниками отеля исходя из главных показателей работы отеля</li>
                <li class="features__item">Управлять ресурсами департаментов</li>
                <li class="features__item">Выстраивать взаимодействие с клиентами на основе принципов межличностного общения и работы с жалобами</li>
                <li class="features__item">Контролировать и оценивать эффективность работы департаментов отеля</li>
            </ul>
        </div>
    </section>
...
<!--                            <button class="form-tooltip__btn" type="button"><img src="images/info-form.svg" alt=""></button>-->
                        ...
                        <div class="form__field">
                            <select class="form__select region_class" name="Region" id="RegionsHR">
