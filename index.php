        ...
        <div class="container">
            ...
            <div class="demand__wrapper">
                <ul class="demand__list">
                    <li class="demand__item"><p>Средняя зарплата - <b>65 000 рублей</b></p></li>
                    <li class="demand__item"><p>Индустрия внутреннего туризма динамично развивается</p></li>
                    <li class="demand__item"><p>Стандарты качества постоянно становятся выше, потребность в компетентных администраторах растет</p></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="prospects__list">
                <li class="prospects__item">
                    ...
                    <ul>
                        <li> Освойте новые навыки и получите знания в востребованной сфере и примените их сразу после обучения</li>
...
<!--                        <li>Пройдете повышение квалификации и получите документ об образовании</li>-->
                ...
                <li class="prospects__item">
                    <h3>Карьерный план <br> и трудоустройство</h3>
                    <ul>
...
<!--                        <li> азработаете пошаговый план по развитию карьеры и выходу на желаемый заработок</li>-->
                ...
                <li class="prospects__item">
                    ...
                    <ul>
                        <li>Удостоверение о повышении квалификации государственного образца</li>
