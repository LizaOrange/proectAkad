...
<main>
    <section class="container breadcrumbs">
        <p><a href="catalog.php">Каталог программ</a>/ Супервайзер службы приема и размещения</p>
    </section>
    ...
    <section class="home home--admin">
        <div class="container">
            <div class="home__content">
                <div class="img-admin">
                    <img src="images/theHeadMobile.webp" loading="lazy" alt="Супервайзер службы приема и размещения">
                </div>
...
<!--                            <button class="form-tooltip__btn" type="button"><img src="images/info-form.svg" alt=""></button>-->
                        ...
                        <div class="form__btn">
                            <button class="btn" id="form-btn" type="button" data-success="false">Учиться бесплатно</button>
                        </div>
                    </div>
                </form>
            </div>
