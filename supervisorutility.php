...
<head>
    ...
    <title>Супервайзер службы гостиничного хозяйства</title>
...
<main>
    <section class="container breadcrumbs">
        <p><a href="catalog.php">Каталог программ</a>/ Супервайзер службы гостиничного хозяйства</p>
    </section>
    ...
    <section class="home home--admin">
        <div class="container">
            <div class="home__content">
                <div class="img-admin">
                    <img src="images/theHeadMobile.webp" loading="lazy" alt="Супервайзер службы гостиничного хозяйства">
                </div>
                ...
                <div class="about__project">
                    ...
                    <div class="about__project__logo">
                        <div class="about__project__logo_upd">
                            ...
                            <img class="logo2" src="images/Logo2.webp" loading="lazy" alt="Министерство труда">
                            <img class="logo3" src="images/Logo3.webp" loading="lazy" alt="Томский Государственный Университет">
        ...
        <div class="container">
            ...
            <div class="causes__items">
                ...
                <div class="causes__item">
                    ...
                    <p>Сотни вакансий на <a href="https://hh.ru/" target="_blank">hh.ru</a></p>
                </div>
                <div class="causes__item">
        ...
        <div class="container">
            ...
            <div class="demand__wrapper-supervisor">
                <ul class="demand__list">
                    <li class="demand__item"><p>Средняя зарплата - <b>85 000 рублей</b></p></li>
    ...
    <section class="features">
        <div class="container">
            ...
            <ul class="features__items">
                <li class="features__item">Работе с законодательными нормами в сфере отельного бизнеса</li>
                <li class="features__item">Основам организации работы отелей</li>
                <li class="features__item">Нюансам в управлении персоналом</li>
                <li class="features__item">Использовать эмоциональный интеллект, основы медиации при взаимодействии с гостями и сотрудниками</li>
            </ul>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ol class="program__modules" data-accordion="parent" data-single="">
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 1. Навыки межличностного общения</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Эмоциональный интеллект и эмпатия</li>
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    ...
                    <ul class="program__module-content" data-accordion="content">
                        ...
                        <li>• Гражданский кодекс, Запрет курения и особенности применения нормативных актов</li>
                        <li>• Гигиенические требования к содержанию жилых помещений и общественных зон</li>
                    </ul>
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 3. Основы организации деятельности гостиниц</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Структура гостиницы</li>
                        <li>• Роль службы гостиничного хозяйства в операционной деятельности гостиницы</li>
                    </ul>
                    <button class="program__module-button" type="button" data-accordion="button" aria-label=" раскрыть/закрыть содержание модуля"></button>
                </li>
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    ...
                    <ul class="program__module-content" data-accordion="content">
                        ...
                        <li>• Приветствие гостя. Навыки межличностного общения</li>
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 6. Основы управления персоналом</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Показатели гостиничной деятельности: загрузка, статусы номеров, прогноз загрузки</li>
                        <li>• Работа с графиками сменности и табелями учета рабочего времени. Заказ расходных материалов</li>
                        <li>• Распределение работ и учет выполненных работ. Система контроля выполненных работ</li>
                        <li>• Обучение сотрудников. Навыки наставничества и обучения на рабочих местах</li>
                    </ul>
                    <button class="program__module-button" type="button" data-accordion="button" aria-label=" раскрыть/закрыть содержание модуля"></button>
                </li>

                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 7. Процедуры обслуживания службой гостиничного хозяйства</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Стандартная операционная процедура уборки гостиничных номеров</li>
                        <li>• Стандартные операционные процедуры обслуживания гостей в номерах</li>
                        <li>• Дополнительный сервис для гостей</li>
                    </ul>
                    <button class="program__module-button" type="button" data-accordion="button" aria-label=" раскрыть/закрыть содержание модуля"></button>
                </li>

                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 8. Специализированные информационные программы и технологии, используемые в работе службы гостиничного хозяйства</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Виды специализированных информационных программ и технологий, используемых в работе службы гостиничного хозяйства</li>
                ...
                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 9. Основные виды деятельности службы гостиничного хозяйства</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Поддержание чистоты в гостинице</li>
                        <li>• Деятельность прачечной, химчистки и бюро забытых вещей</li>
                        <li>• Контроль технического состояния номерного фонда</li>
                        <li>• Руководство персоналом гостиничного хозяйства</li>
                    </ul>
                    <button class="program__module-button" type="button" data-accordion="button" aria-label=" раскрыть/закрыть содержание модуля"></button>
                </li>

                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 10. Основы охраны здоровья, санитарии и гигиены</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Основные требования санитарных правил в гостиничном деле</li>
                        <li>• Соблюдение санитарных норм в службе гостиничного хозяйства</li>
                    </ul>
                    <button class="program__module-button" type="button" data-accordion="button" aria-label=" раскрыть/закрыть содержание модуля"></button>
                </li>

                <li class="program__module" data-accordion="element" data-collapse-item="">
                    <h3 class="program__module-title">Раздел 11. Требования безопасности в службе гостиничного хозяйства</h3>
                    <ul class="program__module-content" data-accordion="content">
                        <li>• Конфиденциальность информации о гостях, сотрудниках и гостинице</li>
                        <li>• Безопасность в гостевых зонах. Открытие дверей гостям, вход в номер, открытие сейфов</li>
                        ...
                        <div class="cases__slide swiper-slide">
                            <div class="cases__slide-content">
                                <div class="cases__slide-info">
                                    <img src="images/photo27.png" loading="lazy" alt="Отзыв 1">
                                    <h4>Карина, 28 лет</h4>
                                </div>
                                <div class="cases__slide-text">
                                    <p>Спасибо команде Cosmos Academy! Уже 5 лет работала администратором без перспектив карьерного роста. Сейчас более глубоко погружена в работу и начинаю видеть точки роста.</p>
                                </div>
                            </div>
                        </div>
                        <div class="cases__slide swiper-slide">
                            <div class="cases__slide-content">
                                <div class="cases__slide-info">
                                    <img src="images/photo28.png" loading="lazy" alt="Отзыв 2">
                                    <h4>Андрей, 25 лет</h4>
                                </div>
                                <div class="cases__slide-text">
                                    <p>Пошел на эту программу, не имея опыта и понимания работы отельного бизнеса. Тем не менее все осознал и теперь жду реализации на практике!</p>
                                </div>
                            </div>
                        </div>
                        <div class="cases__slide swiper-slide">
                            <div class="cases__slide-content">
                                <div class="cases__slide-info">
                                    <img src="images/photo29.png" loading="lazy" alt="Отзыв 3">
                                    <h4>Эля, 33 года</h4>
                                </div>
                                <div class="cases__slide-text">
                                    <p>Никогда не думала, что бесплатное обучение может быть таким же качественным, как и платное. Приятно удивили, спасибо за вашу работу</p>
                                </div>
                            </div>
                        </div>
                        <div class="cases__slide swiper-slide">
                            <div class="cases__slide-content">
                                <div class="cases__slide-info">
                                    <img src="images/photo30.png" loading="lazy" alt="Отзыв 4">
                                    <h4>Игорь, 36 лет</h4>
                                </div>
                                <div class="cases__slide-text">
                                    <p>Решил следовать своему сердцу и давней мечте. Отельный бизнес для меня это сфера, с которой я бы хотел связать свою жизнь, и я рад, что совершил первый шаг к работе, которая будет мне приятна.</p>
                                </div>
                            </div>
                        </div>
                        <div class="cases__slide swiper-slide">
                            <div class="cases__slide-content">
                                <img src="images/photo31.png" loading="lazy" alt="Отзыв 5">
                                <div class="cases__slide-info">
                                    <h4>Полина, 31 год</h4>
                                </div>
                                <div class="cases__slide-text">
                                    <p>Все по полочкам, удобный формат, приятные кураторы. Немного сложно было преодолеть бюрократию при записи, но результат того стоит!</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                            <button class="form-tooltip__btn" type="button"><img src="images/info-form.svg" alt=""></button>-->
                        ...
                        <div class="form__field">
                            <select class="form__select region_class" name="Region" id="RegionSupervisorUtility">
                        ...
                        <input type="hidden" class="program-hidden program-class-text" name="Program" value="Супервайзер службы гостиничного хозяйства">
